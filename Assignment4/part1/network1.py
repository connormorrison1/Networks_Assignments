        ...
        for key in self.rt_tbl_D:
            for type in self.rt_tbl_D[key]:
                ...
                if (type == "RB"):
                    ...
                    if (key == "RB"):
                        secondLine[4] = str(list(self.rt_tbl_D[key][type].values())[0]);
        print("│ " + secondLine[0] + "   │    " + secondLine[1] + " │    " + secondLine[2] + " │    " + secondLine[3] + " │    " + secondLine[4]+ " │")
